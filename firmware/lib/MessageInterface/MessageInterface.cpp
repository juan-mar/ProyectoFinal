...
MessageInterface::Pattern MessageInterface::resolvePattern(UserMessage msg) const {
    switch (msg) {
        ...
        case USER_MSG_POWERING_UP:
            return {MSG_POWERING_UP_R, MSG_POWERING_UP_G, MSG_POWERING_UP_B, MSG_POWERING_UP_INTENSITY, MSG_POWERING_UP_BLINKING, MSG_POWERING_UP_BLINK_RATE_MS};
        case USER_MSG_TRAINING:
            return {MSG_TRAINING_R, MSG_TRAINING_G, MSG_TRAINING_B, MSG_TRAINING_INTENSITY, MSG_TRAINING_BLINKING, MSG_TRAINING_BLINK_RATE_MS};
        case USER_MSG_OFF:
        default:
