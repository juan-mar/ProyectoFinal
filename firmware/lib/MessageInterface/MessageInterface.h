...
#define MSG_ERROR_BLINKING 0
#define MSG_ERROR_BLINK_RATE_MS 150

#define MSG_SUCCESS_R 0
#define MSG_SUCCESS_G 1
#define MSG_SUCCESS_B 0
#define MSG_SUCCESS_INTENSITY 255
#define MSG_SUCCESS_BLINKING 0
#define MSG_SUCCESS_BLINK_RATE_MS 200

#define MSG_SYNCING_R 0
#define MSG_SYNCING_G 0
#define MSG_SYNCING_B 1
#define MSG_SYNCING_INTENSITY 96
#define MSG_SYNCING_BLINKING 1
#define MSG_SYNCING_BLINK_RATE_MS 350

#define MSG_POWERING_UP_R 1
#define MSG_POWERING_UP_G 1
#define MSG_POWERING_UP_B 1
#define MSG_POWERING_UP_INTENSITY 160
#define MSG_POWERING_UP_BLINKING 1
#define MSG_POWERING_UP_BLINK_RATE_MS 250

#define MSG_TRAINING_R 1
#define MSG_TRAINING_G 0
#define MSG_TRAINING_B 1
#define MSG_TRAINING_INTENSITY 128
#define MSG_TRAINING_BLINKING 1
#define MSG_TRAINING_BLINK_RATE_MS 500
