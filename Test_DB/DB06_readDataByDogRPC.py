...
# Usando el RPC sessions_by_dog_code
def sessions_by_dog_code(dog_code, limit=50, desc=True, token=TOKEN):
...
if __name__ == "__main__":
    ...
    sessions_by_dog_code("LUNA-002", limit=20, desc=True, token=tr_token)
